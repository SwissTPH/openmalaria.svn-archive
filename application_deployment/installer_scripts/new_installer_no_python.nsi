...
OutFile "openMalariaTools_installer_v00.04.exe"
...
Section "openMalariaTools" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\openmalariaTools\openmalariaTools.lnk" "$INSTDIR\application\openMalaria.exe"
  CreateShortCut "$DESKTOP\openmalariaTools.lnk" "$INSTDIR\application\openMalaria.exe"
